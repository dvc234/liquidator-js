...
/**
 * Executes a transaction and monitors it until it's confirmed.
 * This function handles nonce management and should not be called in parallel.
 * @param {object} tx - The transaction object to be executed.
 * @param {function} callback - A callback function to be invoked after the transaction is checked.
 * @returns {Promise<object>} An object containing the transaction hash or an error.
 */
...
/**
 * Checks the status of a transaction and takes action based on its state.
 * @param {number} nonce - The nonce of the transaction to check.
 * @param {object} signer - The ethers signer object.
 * @param {number} intents - The number of attempts made to check the transaction.
 * @param {function} callback - A callback function to be invoked after the transaction is checked.
 */
...
/**
 * Gets a quote from the Universal Router for a swap.
 ...
 * @param {number} slippageX10000 - The slippage tolerance in basis points.
 * @param {number} deadline - The deadline for the transaction.
 * @param {number} feeX10000 - The fee in basis points.
 * @param {string} feeRecipient - The recipient of the fee.
 * @returns {Promise<object>} An object containing the quote details.
 */
...
/**
 * Sets up a WebSocket provider for monitoring events and adds reconnection handling.
 * @param {Array<object>} filters - An array of filters for the WebSocket provider.
 * @param {function} poolChangeCallback - A callback function to be invoked when a pool changes.
 */
